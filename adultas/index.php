...
<head>
    ...
    <title>Formulario Candidatas 2019 | Federació de Les Fogueres de Sant Joan</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <h1 class="title text-center">Formulario Candidatas 2019</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="section">
                <div class="container">
                    ...
                    <form class="" id="form" action="../lib/saveCandidata.php" method="post" style="margin-bottom:50px;">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group label-static">
                                    ...
                                    <input class="form-control" pattern="\d{1,2}/\d{1,2}/\d{4}" type="date"
                                        data-date-format="dd/mm/yyyy" id="fechanac" name="fechanac" required />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group label-floating">
                                    <label class="control-label">Ciudad</label>
                                    <input type="text" class="form-control" id="ciudad" name="ciudad" maxlength="100"
                                        required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group label-floating">
                                    ...
                                    <input id="anyosfiesta" name="anyosfiesta" type="number" min="0" max="100" class="form-control"
                                        required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group label-floating">
                                    ...
                                    <input type="text" class="form-control" id="dni" name="dni" pattern="^\d{8}[a-zA-Z]$"
                            ...
                            <div class="col-md-4">
                                <div class="form-group label-floating">
                                    ...
                                    <input type="tel" id="telefono" name="telefono" pattern="^[0-9]{9}$" class="form-control"
                                        required>
                                </div>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12" style="margin-top:20px;">
                                ...
                                <textarea class="form-control" id="estudios" name="estudios" maxlength="300"
                                    placeholder="Indicar Estudios y centro donde los cursó (máximo 300 caracteres)"
                        ...
                        <div class="row">
                            <div class="col-md-12" style="margin-top:20px;">
                                ...
                                <textarea class="form-control" id="situacion_laboral" name="situacion_laboral"
                                    maxlength="300" placeholder="Indicar si trabaja actualmente, empresa y profesión (máximo 300 caracteres)"
                                    rows="5" style="margin-top:-20px;" required></textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12" style="margin-top:20px;">
                                <p><input type="checkbox" required name="terms"> Acepto la <a href="http://www.hogueras.es/privacy-policy/"
                                        target="_blank">política de privacidad</a>, el <a href="http://www.hogueras.es/aviso-legal/"
                                        target="_blank">aviso legal</a> y estoy conforme con el texto mostrado en el
                                    pie del formulario.</p>
                            </div>
                        </div>
