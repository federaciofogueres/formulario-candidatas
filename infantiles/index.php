...
<head>
    ...
    <title>Formulario Candidatas Infantiles 2018 | Federació de Les Fogueres de Sant Joan</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <h1 class="title text-center">Formulario Candidatas Infantiles 2018</h1>
                </div>
            </div>
        </div>
    </div>
