                        ...
                        <form class="" id="form" action="../lib/saveCandidata.php" method="post" style="margin-bottom:50px;">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group label-static">
                                        ...
                                        <input class="form-control" type="date" data-date-format="dd/mm/yyyy" id="fechanac" name="fechanac" pattern="\d{1,2}/\d{1,2}/\d{4}" required />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group label-floating">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin-top:20px;">
                                    ...
                                    <textarea class="form-control" id="aficiones" name="aficiones" maxlength="300" placeholder="Indicar qué tipo de actividad realiza y dónde (máximo 300 caracteres)" rows="5" style="margin-top:-20px;" required></textarea>
                                </div>
                            </div>
